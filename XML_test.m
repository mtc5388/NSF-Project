...
%{
This section is no longer needed. The For loop below takes care of this
process instead. This is a good reminder at how to create and append
elements with text so it will remain for reference.
